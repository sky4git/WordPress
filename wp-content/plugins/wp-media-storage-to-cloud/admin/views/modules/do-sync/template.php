<div v-if="doauthcheck == 'ready'" class="w2cloud__cloud--sync">
    <div>
...
<div v-else class="w2cloud__cloud--sync">
  <div class="w2cloud__cloud-sync-content">
    <p class="w2cloud__error"><?php _e('Save auth info to sync media on Digital Ocean Space','w2cloud'); ?></p>
  </div>
</div>
