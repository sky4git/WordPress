<div>
   <div class="headding-wrapper">
        <h2>Sync Test With Google Cloud</h2>
        <p>You've authorized your Gogle Cloud Bucket with Media Storage To Cloud. <br/> Now, run these sync tests to make sure you're ready to sync media files with your cloud storage.</p>
    </div>
